...
images: ['/static/images/blog/proxmox_monitoring/banner.png']
authors: ['default']
---

> [!note]
> В Proxmox v9.0 был добавлен сервер **OpenTelemetry**, который позволяет передавать метрики по протоколу **OTLP/HTTP** на внешний ресивер. Это нововведение позволяет собирать метрики [напрямую с помощью Prometheus](/blog/monitoring-proxmox-s-ispolzovaniem-opentelemetry-i-prometheus) без использования PVE-exporter.
