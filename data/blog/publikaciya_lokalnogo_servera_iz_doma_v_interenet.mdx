---
title: 'Публикация локального сервера из дома в интеренет'
date: '2024-06-19'
lastmod: '2024-06-19'
tags: ['docker', 'nginx', 'npm', 'cloudflare', 'dns', 'homelab']
summary: 'Публикация локального сервера из дома в интеренет с помощью Nginx Proxy Manager и Cloudflare'
layout: PostSimple
---
