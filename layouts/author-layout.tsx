  ...
  return (
    <Container className="pt-4 lg:pt-12">
      ...
      <div className="py-8 md:grid md:grid-cols-3">
        <div className="pr-4">
          <ProfileCard />
          <h3 className="pb-2 pt-4 text-2xl font-bold leading-8 tracking-tight">Социальные сети:</h3>
          <SocialAccounts />
          {/* <Image
        ...
        <div className="md:col-span-2 md:pl-12 xl:pl-16">
          <div className="prose prose-lg dark:prose-invert">
            ...
            <div>
              ...
              <li>Публикации в формате <strong>MARKDOWN</strong>. (Позволяют легко публиковать заметки из <strong>Obsidian</strong>)</li>
              
              <li>Отсутствие базы данных (упрощает хранение и обслуживание)</li>
              
              <li>Исходный код и содержимое сайта хранятся в репозитории <strong>GitHub</strong>.</li>
              
              <li>Пайплайн CI/CD при помощи GitHub Actions (автоматический деплой из репозитория после каждого <code>git push</code>)</li>
              
              <li>Сайт имеет почти идеальную оценку произвольности <strong>Lighthouse</strong>.</li>
              ...
              <li>Для отображение блоков кода и подсветки синтаксиса используется <a href="https://github.com/timlrx/rehype-prism-plus">rehype-prism-plus</a></li>
              <li>Для комментариев используется <a href="https://github.com/giscus/giscus">giscus</a></li>
            </div>
            <div>
              ...
              <p>
                ...
                и шаблона <a href="https://tailwind-nextjs-starter-blog.vercel.app/">Tailwind Nextjs Starter Blog</a>.
              </p>
              <p>
              ...
              <ul>
                ...
                <li>
                  <Twemoji emoji="eyes" /> Внесены небольшие изменения в тему, иконки и структуру сайта.
                </li>
                <li>
                  <Twemoji emoji="man-technologist" /> Этот веб-сайт использует дизайн и код из репозитория{' '}
            ...
            <div>
              <h2>Ресурсы</h2>
              <p>
                  Большинство изображений взяты из{' '}
